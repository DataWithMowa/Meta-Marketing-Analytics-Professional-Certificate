...
## 📅 Course 1: The 4-Week Roadmap

* Week 1: Week 1: Why Analytics Matters
Understanding the roles of a marketer versus a marketing analyst and seeing how they work hand in hand. You will map out core marketing tasks and see exactly where data fits into each one.


* Week 2: Week 2: Data Sources & Collection
Exploring where marketing data comes from. This covers tracking offline user behavior, collecting digital data (website visits, online purchases), and learning about the back-end tracking tools that make online data collection possible.


* Week 3: Week 3: The Analyst’s Toolbox
An introduction to the core measurement, reporting, and analytics tools:

* **Spreadsheets:** Structuring, analyzing, and visualizing basic data.
* **Web Analytics:** Using platforms like *Google Analytics* to understand online user behavior.
* **Platform Tools:** Navigating built-in tracking setups like *Facebook/Meta Ads Manager*.


* Week 4: Week 4: Data, Privacy & Regulations
Studying the ethics and boundaries of using consumer data. You will look at privacy through three distinct lenses: the consumer's expectations, the advertiser's requirements, and the official legal protections and regulations you must comply with.
...
| --- | --- | --- |
| **Week 1** | 📝 Graded Quiz: Use Cases for Data | Analyzing and categorizing real-world examples using the 5 main use cases of marketing data. |
| **Week 2** | 📝 Graded Quiz: Data Sources | Distinguishing between 1st, 2nd, and 3rd-party data, and how tracking tools connect to platforms. |
| **Week 3** | 📝 Graded Quiz: Measurement Tools | Demonstrating practical use of spreadsheets, data visualization, and Google Analytics. |
...
* **Her Education:** She is a trained psychologist with a Master’s degree in **Consumer Behavior and Marketing**.
* **The Corporate Foundation:** She spent 8 years at **Yahoo** in Silicon Valley leading a global marketing research team during the early rise of the internet, where she heavily used web analytics.
* **The Entrepreneurial Phase:** She co-founded a software company called **Jump Time** focused on ad revenue optimization, which she later successfully sold to an advertising technology company called **OpenX**.
* **Academic & Course Creation:** She joined the faculty at the **UCLA Anderson School of Management** to teach digital marketing in their MBA program. She also co-founded **Aptly**, a team that partners directly with Meta (Facebook) to build these exact digital education programs.
...
* **The Mission:** This certificate program was built in partnership with Coursera to make high-quality digital skills training accessible to absolutely everyone, even if you have zero prior experience or background in tech.
...
## 💼 The 4 Career Paths for a Marketing Analyst

| Workplace | What You Do There |
| --- | --- |
| **1. Advertising Agencies** | You work in the "Marketing Science" department. You back up the creative teams with hard research, prove to clients that ads are working, and decide exactly where to spend client budgets. |
| **2. Internal Corporate Teams** | You work directly for a single large brand. You are the data anchor for the marketing team, helping them forecast future sales, plan yearly budgets, and optimize internal spending. |
| **3. Specialized Analytics Firms** | These are specialized data agencies that small-to-medium businesses hire when they don't have their own internal data teams. Here, you can do core data analysis, client account management, or even analytical sales. |
| **4. Small Business "Hybrid" Roles** | In smaller companies, you wear multiple hats. You act as both the traditional marketer *and* the data analyst, using your tools to run and measure campaigns yourself without a corporate department backing you up. |
